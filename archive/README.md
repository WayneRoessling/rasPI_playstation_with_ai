...
| [repair_pi_rootfs.sh](repair_pi_rootfs.sh) | WSL2 script to repair the SD card's corrupted root filesystem | The card was counterfeit and is gone; the NVMe path doesn't need it |
